...
{
	private AllLines  _theNumbers    = new AllLines(1, 50, 5);
	private AllLines  _theStars      = new AllLines(1, 11, 2);
	...
	public EuroMillions(String title) {
		super(title);
	...
	private void init()
	{
		...
		listScroller.setPreferredSize(new Dimension(140, 130));
	...
	public void select()
	{
		...
		{
			EuroMillionsLine line = new EuroMillionsLine(_theNumbers, _theStars);
	...
	public void selectedHowOften()
	{
		...
		_theNumbers.setExclusion(_howOften.getSelectedIndex() + 1);
		_theStars.setExclusion(_howOften.getSelectedIndex() + 1);
	} // selectedHowOften
